...
## Core Concepts Used
- Graphs (BFS/DFS) for campus navigation
- Queues and Priority Queues for booking requests
- Hash Tables for fast resource lookup
- Binary Search Trees (BST) for student record management
- Sorting algorithms and file handling for persistence
